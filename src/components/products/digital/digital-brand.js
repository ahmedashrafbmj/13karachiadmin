...
const Digital_brand = () => {
	...
	const handleFormSubmit = async () => {
		...
		if (editingRow?._id) {
			try {
				...
				const response = await axios.put(`${baseurl.url}updateBrand/${editingRow?._id}`, formData, {
					headers: {
	...
	const handleCheckboxChange = (e, type) => {
		...
		if (isChecked) {
			...
			if (type === 'selectedBrand') {
				setSelectedBrands(selectedBrands.filter((brand) => brand._id !== brandId));
			} else {
											...
											<Form>
												...
												<FormGroup>
													...
													<Input
														...
														defaultValue={editingRow?._id ? editingRow?.link : null}
													/>
												</FormGroup>
